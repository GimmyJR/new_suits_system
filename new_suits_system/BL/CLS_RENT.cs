...
namespace new_suits_system.BL
{
    internal class CLS_RENT
    {
        ...
        public DataTable search_pro_id(string cri)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DataTable dt = new DataTable();
            SqlParameter[] param = new SqlParameter[1];
            ...
            param[0].Value = cri;
            dt = DAL.SelectData("search_pro_id", param);
            DAL.Close();
            return dt;
        }
        public DataTable search_pro_nme(string cri)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DataTable dt = new DataTable();
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@cri", SqlDbType.VarChar, 500);
            param[0].Value = cri;
            dt = DAL.SelectData("search_pro_nme", param);
            DAL.Close();
            return dt;
        }

        public string get_notes(int id_order)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            string dt;
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@fatora_id", SqlDbType.Int);
            param[0].Value = id_order;
            dt = DAL.SelectData("get_notes", param).ToString();
            DAL.Close();
            return dt;
        ...
        public DataTable search_date(DateTime cri)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DataTable dt = new DataTable();
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@cri", SqlDbType.Date);
            param[0].Value = cri;
            dt = DAL.SelectData("search_date", param);
            DAL.Close();
            return dt;
        }

        public DataTable search_id(int cri)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DataTable dt = new DataTable();
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@cri", SqlDbType.Int);
            param[0].Value = cri;
            dt = DAL.SelectData("search_id", param);
            DAL.Close();
            return dt;
        }
