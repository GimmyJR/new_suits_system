...
namespace new_suits_system.PL
{
    public partial class FRM_MAIN : Form
    {
        ...
        private void انشاءباركودToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FRM_GENRATE_BARCODE frm=new FRM_GENRATE_BARCODE();
            frm.ShowDialog();
        }

        private void التقريراليوميToolStripMenuItem_Click(object sender, EventArgs e)
        {
            tdy_rpt tdy_Rpt = new tdy_rpt();
            tdy_Rpt.ShowDialog();
        }
    }
}
